# Generated by Django 2.2.24 on 2022-05-22 12:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('property', '0013_auto_20220522_1455'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='owner',
            name='flats',
            field=models.ManyToManyField(db_index=True, related_name='owners_flats', to='property.Flat', verbose_name='Квартиры владельца'),
        ),
        migrations.AlterField(
            model_name='owner',
            name='owner',
